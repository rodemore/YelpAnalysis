...
def normalize_comments(comment):
    ...
    comment = [w for w in comment if not w in set(stopwords.words('english'))]
    return comment
...
def perf_measure(y_actual, y_hat):
    # https://stackoverflow.com/comments/31324218/scikit-learn-how-to-obtain-true-positive-true-negative-false-positive-and-fal
    TP = 0
    FP = 0
    TN = 0
    FN = 0
